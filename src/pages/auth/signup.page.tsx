...
import {
    ...
    selectEmail, selectFirstName, selectLastName, selectPassword, selectPhone, selectProfilePicture, selectUsername,
    setConfirmPassword, setEmail, setFirstName, setLastName,
    setPassword,
    setUsername
