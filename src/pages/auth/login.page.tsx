...
import {selectAuth, setLoading, setUser} from "../../redux/slices/authSlice";
import {identify, login} from "../../api";
...
const LoginPage = () => {
    ...
    const handleLoginButton = async () => {
        ...
        if (!email || !password) {
            setError("Voer een email en wachtwoord in.");
            return;
        }
            ...
            <Wrapper id="auth-login" style={{height: `${height}px`}}>
                ...
                <FormWrapper>
                    ...
                    <Form>
                        ...
                        <InputWrapper>
                            <button onSubmit={handleLoginButton} type="submit" className="btn btn-primary">Login
                            </button>
                        </InputWrapper>
                    </Form>
                    <OrWrapper>
