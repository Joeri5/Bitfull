    ...
    return (
        <Wrapper>
            <Container>
                ...
                {user ? (
                    <LinkWrapper>
                        <Link to="/profile" className="righteous">
                            {imgUrl ? (
                                <Link to={`/user/${user.username.toLowerCase()}`}>
                                    <ProfileWrapper>
                                        <p>{user.username}</p>
                                        <ProfileImage src={imgUrl} alt={"Profile image of user: " + user.email}/>
                                    </ProfileWrapper>
                                </Link>
                            ) : (
                                <p>{user.email}</p>
                    ...
                    <LinkWrapper>
                        ...
                        <Link to={'/auth/signup'} className="sign_up">
                            Sign Up
                        </Link>
                    </LinkWrapper>
                )}
